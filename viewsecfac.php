...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $_SESSION['sem']=$sem;
    $_SESSION['sec']=$sec;
 echo "<script>alert('$sem---$sec')</script>";
...
if($sem=="sem8")$semtemp="sem8temp";
 $_SESSION['semtemp']=$semtemp;*/
    ...
    header("location: viewsecfaczuckfinal.php");
}
?>
<!DOCTYPE html>
            ...
            <a href="javascript:void(0)" id="close" class="closebtn" onclick="closeNav()">CLOSE <i class="fa fa-remove"></i></a>
                        ...
                        <button class="dropdown-btn">Section Details
                            ...
                            <div class="dropdown-container">
                                ...
                                <a href="viewsecfac.php" target="_self">View Section Faculty</a>
                                <a href="semselectclear.php" target="_self">Delete Section Faculty</a></div>
