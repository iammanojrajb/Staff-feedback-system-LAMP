...
.sidenav a, .dropdown-btn {
    ...
    outline: none;
    font-size: 20px;
    font-family:"Average Sans" /*"Lucida Sans Unicode"*/;
}
		...
		<div >
			...
			<a href="javascript:void(0)" id="close" class="closebtn" onclick="closeNav()">CLOSE <i class="fa fa-remove"></i></a>
                        ...
                        <div class="dropdown-container">
                          ...
                          <a href="delfac.php" target="_self">Delete Faculty</a></div>

                        <button class="dropdown-btn">Subject Details
                            <i class="fa fa-angle-double-down"></i>
                              </button>
                              <div class="dropdown-container">
...
<div class="column middle">
    <h1 style="font-size:70px; color:#E4F1FE; font-family:'Gafata';"><center>WELCOME ADMIN</center></h1>
   </div>
