...
if($sem=="sem8")$semtemp="sem8temp";
 $_SESSION['semtemp']=$semtemp;
    header("location: finalreportgen.php");
  }
  if($com=="clearreport")
  {
    $sem=$_POST['sem'];
...
if($sem=="sem8")$semtemp="sem8temp";
 $_SESSION['semtemp']=$semtemp;
    header("location: semtempcolumdel.php");
  }
...
<body style="background-attachment:fixed; background-image: url('g3.jpg'); min-height: 100%; opacity: 0.6;">

<div>
<div class="flex-container">
<!--<header>
  <h1 style="font-family: 'Gafata';">ADD SUBJECT</h1>
</header>
</div>-->
