...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
  ...
  $equ=mysqli_query($Conn,$qname);
   if($equ)
          {
            $name=str_replace("_"," ",$name);
            echo "<script>alert('$showname inserted in $depname successfully;')</script>";
          }
          else
          {
...
<div class="column middle">
  <center style="font-size:40px;font-family: 'Gafata';"><u style="color: #AC3B61">ADD FACULTY</u>
  <div class="heads">
        <div><span>Staff Name: </span></div>
  </div>
  <div class="login">
      <form name="add" action="" method="post" id="logtop">
      <input name="facname" id="add staff" type="text" size="40" maxlength="30" placeholder="Enter faculty name">
