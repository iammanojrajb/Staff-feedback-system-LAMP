...
$qname="CREATE TABLE $t (temp VARCHAR(3))";
...
if($qname)
  ...
  $equ=mysqli_query($Conn,$qname);
   if($equ)
          ...
          /*else
          {
              echo "<script>alert('Section $t not created in $depname')</script>";
          }  
*/
$qname="CREATE TABLE $ttemp (temp VARCHAR(3))";
...
<center style="font-size:40px;font-family: 'Gafata';"><u  style="color: #AC3B61">Create Section</u>
<div class="heads">
 		<div style="float: right;"><span >Sem:</span></div><br>
        <div ><span>No. of Section:</span></div>
		</div>
...
<div class="login">
  ...
  <br>
  <!--<input type="type" name="section">-->

<select name="section">
  <option>---SELECT NO. OF SEC---</option>
